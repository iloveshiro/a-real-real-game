...
space = pg.image.load('background.png')
...
pg.mixer.music.load('cosmo_music.wav')
pg.mixer.music.set_volume(0.2)
pg.mixer.music.play()

l_sound = pg.mixer.Sound('laser_sound.wav')
w_sound = pg.mixer.Sound('win_sound.wav')
